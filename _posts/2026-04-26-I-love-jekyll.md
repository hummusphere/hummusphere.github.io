...
toc:
  ...
  - title: "An Amazing Discovery"
    id: "An-Amazing-Discovery"
  - title: "Other Things Going On"
    id: "Other-Things-Going-On"
---

<div id="blog-content">
    <h3 class="blog-sub-header" id="An-Amazing-Discovery"> An amazing discovery </h3> 
    ...
    <h3 class="blog-sub-header" id="Other-Things-Going-On"> Other things going on </h3>
